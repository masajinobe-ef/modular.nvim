...
-- nvim-lspconfig setup
{
  ...
  config = function()
    ...
    vim.diagnostic.config({
      ...
      signs = {
        severity = {
          [vim.diagnostic.severity.ERROR] = { text = "E", texthl = "DiagnosticError" },
          [vim.diagnostic.severity.WARN]  = { text = "W", texthl = "DiagnosticWarn"  },
          [vim.diagnostic.severity.HINT]  = { text = "H", texthl = "DiagnosticHint"  },
          [vim.diagnostic.severity.INFO]  = { text = "I", texthl = "DiagnosticInfo"  },
        },
      },
    })
