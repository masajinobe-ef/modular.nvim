...
-- Visual settings
vim.opt.wrap = true -- Wrap lines (default: true)
...
vim.wo.signcolumn = 'yes' -- Always show signcolumn (default: 'auto')
vim.opt.cmdheight = 1 -- Command line space (default: 1)
...
vim.opt.hlsearch = false -- Highlight search (default: true)
